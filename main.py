...
def main():
    ...
    current_value.set(127)
    slider = ttk.Scale(frame_button_5, from_=0, to=255, orient='horizontal', command=slider_changed,
    ...
    red_label = tk.Label(frame_count_color, text='0', height=3, width=25)
    red_label.grid(column=0, row=0, padx=10, pady=7, rowspan=2)
    blue_label = tk.Label(frame_count_color, text='0', height=3, width=25)
    blue_label.grid(column=1, row=0, padx=10, pady=7, rowspan=2)
    green_label = tk.Label(frame_count_color, text='0', height=3, width=25)
    ...
    sum_label=tk.Label(frame_sum_count,text='0',height=3,width=80)
    sum_label.grid()
